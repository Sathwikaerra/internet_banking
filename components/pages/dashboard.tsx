...
//                 <CardTitle className="text-xs">Holders & Nominees</CardTitle>
//                 <CardDescription className="text-[10px]">
//                   {isOverview
//                     ? "Select an account on the left to view linked family members"
...
//                     You can view nominees, joint holders & family relationships for a specific
//                     account by selecting it from the left side.
//                   </p>
//                 ) : selectedAccount?.familyDetails?.members &&
//                   selectedAccount.familyDetails.members.length > 0 ? (
//                   <div className="space-y-2">
//                     <div className="p-2 rounded-lg bg-slate-50 border border-slate-100">
//                       <p className="text-[9px] text-slate-500">Primary Holder</p>
...
//                       {selectedAccount.familyDetails.members.map((member: any, idx: number) => (
//                         <div
//                           key={idx}
...
//                             )}
//                           </div>
//                           <span className="text-[9px] px-2 py-0.5 rounded-full bg-blue-50 text-[#233b77] font-semibold">
//                             {member.role}
//                           </span>
//                         </div>
//                       ))}
