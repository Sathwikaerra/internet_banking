...
const UpcomingTransactions = () => {
  ...
  const displayedTxns = showAll ? filteredTxns : filteredTxns.slice(0, 5);
...
<thead className="bg-slate-100 text-slate-700 sticky top-0 z-10 shadow-sm">            <tr>
...
className="hover:bg-blue-50/40 border-b last:border-none transition-all duration-200 cursor-pointer"                  >
                    <td className="p-2">
                  ...
                  {isOpen && (
                    <tr>
<td colSpan={7} className="p-4 bg-gradient-to-r from-slate-50 to-blue-50 border-t">                        <div className="border rounded-xl bg-white shadow-sm p-4 space-y-3">
